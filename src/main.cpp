...
void mainMenu() {
  ...
  case 2:
    ...
    cout << "\nДля запуска ассистента, помогающего выбрать тариф нажмите - 1\n"
         ...
         << "Курсовая работа была создана: Черноколпаков, Дудинский, Кичигин - "
            "ИП-915\n"
         << "\n"
         << endl;
    system("pause");
...
void ob_operatorax() {
  ...
  case 1:
    ...
    cout << "\tТеле 2\n"
         ...
         << "Работает с 2003 года. Владельцем Tele2 Россия является компания "
            "Ростелеком.\n"
         << "По итогам 2019 года, предоставляет услуги сотовой связи более чем "
            "44,6 млн абонентов.\n"
         << "По состоянию на начало апреля 2020 года сеть Tele2 работает в 67 "
  ...
  case 2:
    ...
    cout << "\tМТС\n"
         ...
         << "оказывающая услуги в России и странах СНГ под торговой маркой "
            "«МТС».\n"
         << "Компания оказывает услуги сотовой связи (в стандартах GSM, UMTS "
            "(3G) и LTE),\n"
         << "услуги проводной телефонной связи, широкополосного доступа в "
            "Интернет, мобильного телевидения, кабельного телевидения,\n"
         << "спутникового телевидения, цифрового телевидения и сопутствующие "
            "услуги, в частности услуги по продаже контента.\n"
         << "По состоянию на март 2019 года компания во всех странах своего "
  ...
  case 3:
    ...
    cout << "\tМегафон\n"
         ...
         << "Действует в 83 субъектах Российской Федерации, в Таджикистане, а "
  ...
  case 5:
    ...
    cout << "\tYota\n"
         << "\nТелекоммуникационная компания «Yota» была основана в 2007 году. "
            "На сегодняшний день это один из самых востребованных операторов "
            "мобильной связи\n"
         << "на территории России. Компания предлагает большой комплекс услуг "
            "мобильной связи \n"
